...
do
  case $opt in
    "300x250")
      ...
      ./dist/app.app/Contents/MacOS/app --format 300_250 --copy "$copy" --translate "$translate"
    ...
    "300x600")
      ...
      # read -p "Would you like it to be translated (y/n)? " translate
      echo "Generating assets..."
      ./dist/app.app/Contents/MacOS/app --format 300_600 --copy "$copy" --translate "$translate"
      for o in "${!options[@]}"; do echo "$((o+1)))" "${options[$o]}"; done
      ;;
    "970x250")
